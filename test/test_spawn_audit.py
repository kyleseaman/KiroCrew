...
BENIGN_SPAWNS: frozenset[str] = frozenset(
    {
        ...
        # operator-owned rather than prompt-selected. The call sits in
        # ``_spawn_admitted`` (the admitted half of ``spawn``) after upstream's
        # cold-start admission split; the argv and env are unchanged.
        "acp/runtime.py::_spawn_admitted",
