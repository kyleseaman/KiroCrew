...
class TestDualLayerKmsIsRecognised:
    ...
    def test_a_dsse_bucket_has_its_configuration_restored(self, tmp_path, monkeypatch):
        ...
        assert puts, "the dual-layer configuration was never restored"
