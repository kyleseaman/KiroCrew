...
class SessionManager:
    ...
    def _cleanup_deps(self) -> CleanupDeps:
        ...
        return CleanupDeps(
            ...
            get_background_key=lambda: BACKGROUND_KEY,
    ...
    def __init__(
        ...
        # booting without making a half-started provider claimable. Plain
        # attributes on purpose: upstream backs every other field here with a
        # state object, but these two are branch-new and have no such store.
        self._starting_providers: dict[str, LLMProvider] = {}
        self._on_execution_location_changed: _ExecutionLocationCallback | None = None
