...
**Spec:** `docs/request-for-change/specs/2026-08-24-coder-remote-session-parity-design.md`
...
- Modify: `docs/system-specs/modules/session.md`
- Modify: `docs/system-specs/modules/learn-cron-dashboard.md`
- Modify: `docs/request-for-change/specs/2026-08-24-coder-remote-session-parity-design.md` only if verified implementation differs from the approved contract.
