...
[specs/](specs/README.md) holds dated architectural design documents that predate
this directory's flat `rfc-*.md` convention. They play the RFC role — the *what*
and the *why* — for the plans that name them as their spec. New designs should be
written as a top-level `rfc-<topic>.md` instead of added here.
