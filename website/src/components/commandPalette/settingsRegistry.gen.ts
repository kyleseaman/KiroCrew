...
[
  ...
  {
    "id": "session-environments.autostop-after-inactive-minutes",
    "label": "Autostop after inactive minutes",
    "labelKey": "coder.stop_after_label",
    "tab": "session-environments",
    "type": "input",
    "occurrence": 1,
    "configKey": "session.coder.stop_after_minutes"
  },
  {
    "id": "session-environments.coder-session-token",
  ...
  {
    "id": "session-environments.coder-url",
    "label": "Coder URL",
  ...
  {
    "id": "session-environments.delete-after-inactive-days",
  ...
  {
    "id": "session-environments.maximum-running-workspaces",
  ...
  {
    "id": "session-environments.profile-name",
    "label": "Profile name",
  ...
  {
    "id": "session-environments.remote-working-directory",
  ...
  {
    "id": "session-environments.runtime-warm-minutes",
  ...
  {
    "id": "session-environments.template-preset",
  ...
  {
    "id": "session-environments.use-coder-for-new-sessions",
  ...
  {
    "id": "session-environments.workspace-name-prefix",
  ...
  {
    "id": "session-environments.workspace-template",
