...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    // Same class of rename: the vendor-named Coder destination became the
    // provider-neutral Session Environments one. An old ?tab=coder bookmark
    // would otherwise translate to a tab that no longer exists and land on
    // Overview.
    if (tab === 'coder') tab = 'session-environments'
